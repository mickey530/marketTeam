...
<main class="form-signin text-center">
  <form action="http://localhost:8181/ICT_MARKET/userJoinCheck.com" method="post">
    ...
    <h1 class="h3 mb-3 align-middle">Sign-up</h1>
    ...
    <div class="form-floating">
      <input type="text" class="form-control" name="phone" placeholder="Contect number" required>
      <label for="floatingInput">Contect number</label>
    </div><br/>    
    <div class="form-floating">
