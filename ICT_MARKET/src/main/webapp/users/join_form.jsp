...
<div class="main text-center">
	<main class="form-signin">
		...
		<form action="http://localhost:8181/ICT_MARKET/ICTJ"  method="post">
			...
			<div class="form-floating" >
				<input type="password" placeholder="PW" class="form-control" name="pw"required>
	 			<label for="password" class="form-label">PW</label>			
			</div>
			<div class="form-floating" >
				<input type="text" placeholder="Contect number" class="form-control" name="phone" maxlength="11" required>
	 			<label for="phone" class="form-label">Contect number</label>			
			</div>
			<div class="form-floating" >
				<input type="text" placeholder="Address" class="form-control" name="addr" size="50">
	 			<label for="addr" class="form-label">Address</label>			
			</div>			

			<input class="btn btn-outline-primary col-12" type="submit" value="Sign-up"> 
			<!-- <input class="btn btn-outline-secondary col-12" type="reset" value="초기화"> -->
		</form>
	</main>
</div>
</div>
