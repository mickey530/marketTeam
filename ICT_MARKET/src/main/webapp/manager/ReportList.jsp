...
<table class="table table-hover" style="font-size:80%">
		...
		<tr>
			...
			<td class="col-md-8">	
				<a href="http://localhost:8181/ICT_MARKET/reportDetail.com?reported_num=${report.reported_num}&reported_board_num=${report.reported_board_num}" style="text-decoration:none;">
