...
public class BoardVO {
	...
	public BoardVO(String user_id, boolean board_info, int board_num, String board_content, String board_category,
			int board_amount, boolean board_sold, int board_reported, Date board_writetime, Date board_updatetime) {
		super();
	...
	public String toString() {
		return "BoardVO [user_id=" + user_id + ", board_info=" + board_info + ", board_num=" + board_num
				...
				+ board_amount + ", board_sold=" + board_sold + ", board_reported=" + board_reported
				+ ", board_writetime=" + board_writetime + ", board_updatetime=" + board_updatetime + "]";
	}	
